...
def main(ini_path, zone_type='gridmet', overwrite_flag=False):
    ...
    for input_ftr in input_lyr:
        ...
        centroid_geom = input_geom.Centroid()
        et_cells_data[input_fid]['X'] = centroid_geom.GetX()
        et_cells_data[input_fid]['Y'] = centroid_geom.GetY()
        for f in input_fields:
            et_cells_data[input_fid][f] = input_ftr.GetField(
